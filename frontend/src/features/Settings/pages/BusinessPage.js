...
const BusinessPage = () => {
  ...
  if (!can('business_settings', 'update')) { // Assumindo permissão para atualizar configurações de negócio
    return (
      <Box sx={{ p: 4 }}>
        <Alert severity="warning">
          {t('common.module_not_enabled', { moduleName: t('modules.business_settings') })}
        </Alert>
      </Box>
    );
  }
