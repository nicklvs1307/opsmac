...
import FinancialTransactionFormModal from '../../../shared/components/FinancialTransactionFormModal'; // Adjust path as needed
import {
...
const FinancialTransactions = () => {
  ...
  const {
    ...
    `/api/financial/transactions?restaurant_id=${restaurantId}&type=${filters.type}&category_id=${filters.category_id}&start_date=${filters.start_date}&end_date=${filters.end_date}`
  );
