      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-5">
          ...
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-md text-sm transition-all duration-300 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-200"
            required
          />
        </div>
        <div className="mb-5">
            ...
            {formData.variations.map((variation, index) => (
              <div key={index} className="flex gap-2 mb-2 items-center">
                <input
                  ...
                  className="flex-1 w-full p-3 border border-gray-300 rounded-md text-sm transition-all duration-300 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-200"
