...
module.exports = (db) => {
  ...
  router.get(
    "/users",
    auth,
    requirePermission("restaurant_users", "read"),
    asyncHandler(restaurantController.listRestaurantUsers),
  );
  router.post(
    "/users",
    auth,
  ...
  router.delete(
    "/users/:userId",
    auth,
    requirePermission("restaurant_users", "delete"),
    asyncHandler(restaurantController.deleteRestaurantUser),
  );
  ...
  router.get(
    "/addons",
    auth,
    requirePermission("restaurant_addons", "read"),
    asyncHandler(restaurantController.getRestaurantAddons),
  );
  router.post(
    "/addons",
    auth,
  ...
  router.delete(
    "/addons/:addonId",
    auth,
    requirePermission("restaurant_addons", "delete"),
    asyncHandler(restaurantController.deleteRestaurantAddon),
  );
  ...
  router.get(
    "/cash-register-categories",
    auth,
    requirePermission("restaurant_cash_register_categories", "read"),
    asyncHandler(restaurantController.getRestaurantCashRegisterCategories),
  );
  router.post(
    "/cash-register-categories",
    auth,
  ...
  router.delete(
    "/cash-register-categories/:cashRegisterCategoryId",
    auth,
    requirePermission("restaurant_cash_register_categories", "delete"),
    asyncHandler(restaurantController.deleteRestaurantCashRegisterCategory),
  );
  ...
  router.get(
    "/categories",
    auth,
    requirePermission("restaurant_categories", "read"),
    asyncHandler(restaurantController.getRestaurantCategories),
  );
  router.post(
    "/categories",
    auth,
  ...
  router.delete(
    "/categories/:categoryId",
    auth,
    requirePermission("restaurant_categories", "delete"),
    asyncHandler(restaurantController.deleteRestaurantCategory),
  );
  ...
  router.get(
    "/financial-categories",
    auth,
    requirePermission("restaurant_financial_categories", "read"),
    asyncHandler(restaurantController.getRestaurantFinancialCategories),
  );
  router.post(
    "/financial-categories",
    auth,
  ...
  router.delete(
    "/financial-categories/:financialCategoryId",
    auth,
    requirePermission("restaurant_financial_categories", "delete"),
    asyncHandler(restaurantController.deleteRestaurantFinancialCategory),
  );
  ...
  router.get(
    "/ingredients",
    auth,
    requirePermission("restaurant_ingredients", "read"),
    asyncHandler(restaurantController.getRestaurantIngredients),
  );
  router.post(
    "/ingredients",
    auth,
  ...
  router.delete(
    "/ingredients/:ingredientId",
    auth,
    requirePermission("restaurant_ingredients", "delete"),
    asyncHandler(restaurantController.deleteRestaurantIngredient),
  );
  ...
  router.get(
    "/products",
    auth,
    requirePermission("restaurant_products", "read"),
    asyncHandler(restaurantController.getRestaurantProducts),
  );
  router.post(
    "/products",
    auth,
  ...
  router.delete(
    "/:productId",
    auth,
    requirePermission("restaurant_products", "delete"),
    asyncHandler(restaurantController.deleteRestaurantProduct),
  );
  ...
  router.get(
    "/suppliers",
    auth,
    requirePermission("restaurant_suppliers", "read"),
    asyncHandler(restaurantController.getRestaurantSuppliers),
  );
  router.post(
    "/suppliers",
    auth,
  ...
  router.delete(
    "/suppliers/:supplierId",
    auth,
    requirePermission("restaurant_suppliers", "delete"),
    asyncHandler(restaurantController.deleteRestaurantSupplier),
  );
  ...
  router.get(
    "/tables",
    auth,
    requirePermission("restaurant_tables", "read"),
    asyncHandler(restaurantController.getRestaurantTables),
  );
  router.post(
    "/tables",
    auth,
  ...
  router.delete(
    "/tables/:tableId",
    auth,
    requirePermission("restaurant_tables", "delete"),
    asyncHandler(restaurantController.deleteRestaurantTable),
  );
  ...
  router.get(
    "/technical-specifications",
    auth,
    requirePermission("restaurant_technical_specifications", "read"),
    asyncHandler(restaurantController.getRestaurantTechnicalSpecifications),
  );
  router.post(
    "/technical-specifications",
    auth,
  ...
  router.delete(
    "/technical-specifications/:technicalSpecificationId",
    auth,
    requirePermission("restaurant_technical_specifications", "delete"),
    asyncHandler(restaurantController.deleteRestaurantTechnicalSpecification),
  );
