...
import apiClient from '@/shared/lib/axiosInstance.js';
  ...
  const renderStepContent = () => {
    switch (step) {
      ...
      case 2:
        ...
        return (
          <section id="selecionar-grupo-section" className={styles['content-section']}>
            <div className={styles['section-header']}>
            ...
            <div className={styles['item-grid']}>
              {groups.map((g) => (
                ...
                >
                  <span className={styles['item-name']}>{g.name}</span>
                </div>
              ))}
            </div>
            ...
            <div className={`${styles['imprimir-container']} ${styles.card}`}>
              ...
              <div className={styles['etiqueta-form-container']}>
                ...
                <div className={styles['form-actions']}>
                  ...
                  <button onClick={handlePrint} className={`${styles.btn} ${styles['btn-danger']}`}>
                    Imprimir
                  </button>
                </div>
              </div>
