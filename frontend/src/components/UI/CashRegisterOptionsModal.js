...
const CashRegisterOptionsModal = ({
  open,
  handleClose,
  currentSession,
  setWithdrawalModalOpen,
  setReinforcementModalOpen,
  setPartialSummaryModalOpen,
  setCloseCashRegisterModalOpen,
}) => {
      ...
      <Box sx={style}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <Button
            ...
            onClick={() => {
              handleClose();
              setReinforcementModalOpen(true);
            }}
          >
            {t('pdv.reinforcement')}
          </Button>
          ...
          <Button
            ...
            onClick={() => {
              handleClose();
              setCloseCashRegisterModalOpen(true);
            }}
          >
