...
module.exports = (db) => {
    ...
    return {
        ...
        uploadUserAvatar: async (req, res, next) => {
            ...
            await auditService.log(req.user, null, 'USER_AVATAR_UPLOADED', `User:${userId}`, { avatarUrl });
        ...
        updateRestaurantSettings: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'RESTAURANT_SETTINGS_UPDATED', `Restaurant:${restaurantId}`, { updatedSettings: req.body.settings });
        ...
        uploadRestaurantLogo: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'RESTAURANT_LOGO_UPLOADED', `Restaurant:${restaurantId}`, { logoUrl });
        ...
        generateApiToken: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'API_TOKEN_GENERATED', `Restaurant:${restaurantId}`, {});
        ...
        revokeApiToken: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'API_TOKEN_REVOKED', `Restaurant:${restaurantId}`, {});
        ...
        updateWhatsappSettings: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'WHATSAPP_SETTINGS_UPDATED', `Restaurant:${restaurantId}`, { updatedSettings: req.body });
        ...
        testWhatsappMessage: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'WHATSAPP_TEST_MESSAGE_SENT', `Restaurant:${restaurantId}`, { recipient });
        ...
        updateRestaurantProfile: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'RESTAURANT_PROFILE_UPDATED', `Restaurant:${restaurantId}`, { updatedData: req.body });
        ...
        updateNpsCriteria: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'NPS_CRITERIA_UPDATED', `Restaurant:${restaurantId}`, { updatedNpsCriteria: req.body.nps_criteria });
