...
exports.generateReportValidation = [
  query('report_type').isIn(['nps', 'satisfaction', 'complaints', 'trends', 'customers']).withMessage('Tipo de relatório deve ser: nps, satisfaction, complaints, trends ou customers'),
