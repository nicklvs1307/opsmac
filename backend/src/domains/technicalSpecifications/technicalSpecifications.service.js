...
module.exports = (db) => {
    ...
    const getTechnicalSpecificationByProductId = async (productId, restaurantId) => {
    ...
    const updateTechnicalSpecification = async (productId, recipe_ingredients, restaurantId) => {
        const technicalSpecification = await models.TechnicalSpecification.findOne({
            where: { product_id: productId },
        });
        if (!technicalSpecification) {
