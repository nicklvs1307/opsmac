...
const restaurantService = require("domains/restaurant/restaurant.service"); // Existing restaurant service
...
exports.updateRestaurantOpenStatus =
...
exports.createRestaurantPaymentMethod = async (
  restaurantId,
  name,
  isActive,
) => {
...
exports.updateRestaurantPaymentMethod = async (
  restaurantId,
  paymentMethodId,
  name,
  isActive,
...
exports.deleteRestaurantPaymentMethod = async (
  restaurantId,
  paymentMethodId,
) => {
