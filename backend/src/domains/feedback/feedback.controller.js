...
module.exports = (db) => {
    ...
    return {
        createFeedback: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'FEEDBACK_CREATED', `Feedback:${feedback.id}`, { rating: feedback.rating, comment: feedback.comment });
        ...
        updateFeedback: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'FEEDBACK_UPDATED', `Feedback:${updatedFeedback.id}`, { updatedData: req.body });
        ...
        deleteFeedback: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'FEEDBACK_DELETED', `Feedback:${req.params.id}`, {});
        ...
        respondToFeedback: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'FEEDBACK_RESPONDED', `Feedback:${feedback.id}`, { responseText: req.body.response_text });
