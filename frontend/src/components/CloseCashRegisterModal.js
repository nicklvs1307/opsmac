...
const CloseCashRegisterModal = ({ open, handleClose, handleSave, currentSession, movements, cashOrders }) => {
        ...
        {currentSession && (
          <Box sx={{ mt: 2, mb: 2 }}>
            ...
            <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
              {t('pdv.expected_cash')}: R$ {calculateCurrentCash(currentSession, movements, cashOrders).toFixed(2).replace('.', ',')}
            </Typography>
          </Box>
        )}
        <TextField
