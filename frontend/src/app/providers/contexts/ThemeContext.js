        ...
        components: {
          ...
          MuiAlert: {
            styleOverrides: {
              ...
              standardSuccess: {
                backgroundColor:
                  mode === 'light' ? 'rgba(76, 175, 80, 0.1)' : 'rgba(76, 175, 80, 0.15)',
                color: mode === 'light' ? '#2e7d32' : '#81c784',
              },
              standardInfo: {
                backgroundColor:
                  mode === 'light' ? 'rgba(33, 150, 243, 0.1)' : 'rgba(33, 150, 243, 0.15)',
                color: mode === 'light' ? '#0277bd' : '#64b5f6',
              },
              standardWarning: {
                backgroundColor:
                  mode === 'light' ? 'rgba(255, 152, 0, 0.1)' : 'rgba(255, 152, 0, 0.15)',
                color: mode === 'light' ? '#ef6c00' : '#ffb74d',
              },
              standardError: {
                backgroundColor:
                  mode === 'light' ? 'rgba(244, 67, 54, 0.1)' : 'rgba(244, 67, 54, 0.15)',
          ...
          MuiChip: {
            styleOverrides: {
              ...
              colorPrimary: {
                ...
                '&:hover': {
                  backgroundColor:
                    mode === 'light' ? 'rgba(211, 47, 47, 0.18)' : 'rgba(255, 82, 82, 0.18)',
                },
              },
              colorSecondary: {
                backgroundColor:
                  mode === 'light' ? 'rgba(220, 0, 78, 0.12)' : 'rgba(255, 64, 129, 0.12)',
                color: mode === 'light' ? '#dc004e' : '#ff4081',
                '&:hover': {
                  backgroundColor:
                    mode === 'light' ? 'rgba(220, 0, 78, 0.18)' : 'rgba(255, 64, 129, 0.18)',
                },
              },
              outlined: {
                borderWidth: '1.5px',
          ...
          MuiDialog: {
            styleOverrides: {
              paper: {
                borderRadius: 16,
                boxShadow:
                  mode === 'light' ? '0 8px 32px rgba(0,0,0,0.15)' : '0 8px 32px rgba(0,0,0,0.5)',
                backgroundImage:
                  mode === 'light'
          ...
          MuiTableHead: {
            styleOverrides: {
              root: {
                backgroundColor:
                  mode === 'light' ? 'rgba(211, 47, 47, 0.05)' : 'rgba(255, 82, 82, 0.05)',
                '& .MuiTableCell-head': {
                  fontWeight: 600,
          ...
          MuiTableRow: {
            styleOverrides: {
              root: {
                ...
                '&:hover': {
                  backgroundColor:
                    mode === 'light' ? 'rgba(0, 0, 0, 0.02)' : 'rgba(255, 255, 255, 0.02)',
                },
              },
            },
          },
