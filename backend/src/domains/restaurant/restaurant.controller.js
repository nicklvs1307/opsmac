module.exports = (restaurantService) => {
  ...
  const updateRestaurant = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_UPDATED', `Restaurant:${restaurantId}`, { updatedData: restaurantData });
  ...
  const updateRestaurantOpenStatus = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_OPEN_STATUS_UPDATED', `Restaurant:${restaurantId}`, { is_open });
    res.json(updatedRestaurant);
  };
  ...
  const updateRestaurantPosStatus = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_POS_STATUS_UPDATED', `Restaurant:${restaurantId}`, { pos_status });
    res.json(updatedRestaurant);
  };
  ...
  const createRestaurantUser = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_USER_CREATED', `User:${newUser.id}`, { email: newUser.email });
  ...
  const updateRestaurantUser = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_USER_UPDATED', `User:${userId}`, { updatedData: req.body });
  ...
  const deleteRestaurantUser = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_USER_DELETED', `User:${userId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantAddon = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_ADDON_CREATED', `Addon:${newAddon.id}`, { name: newAddon.name });
  ...
  const updateRestaurantAddon = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_ADDON_UPDATED', `Addon:${addonId}`, { updatedData: req.body });
  ...
  const deleteRestaurantAddon = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_ADDON_DELETED', `Addon:${addonId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantCashRegisterCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_CASH_REGISTER_CATEGORY_CREATED', `Category:${newCategory.id}`, { name: newCategory.name });
  ...
  const updateRestaurantCashRegisterCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_CASH_REGISTER_CATEGORY_UPDATED', `Category:${cashRegisterCategoryId}`, { updatedData: req.body });
  ...
  const deleteRestaurantCashRegisterCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_CASH_REGISTER_CATEGORY_DELETED', `Category:${cashRegisterCategoryId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_CATEGORY_CREATED', `Category:${newCategory.id}`, { name: newCategory.name });
    res.status(201).json(newCategory);
  };
  ...
  const updateRestaurantCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_CATEGORY_UPDATED', `Category:${categoryId}`, { updatedData: req.body });
    res.json(updatedCategory);
  };
  ...
  const deleteRestaurantCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_CATEGORY_DELETED', `Category:${categoryId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantFinancialCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_FINANCIAL_CATEGORY_CREATED', `Category:${newCategory.id}`, { name: newCategory.name });
    res.status(201).json(newCategory);
  };
  ...
  const updateRestaurantFinancialCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_FINANCIAL_CATEGORY_UPDATED', `Category:${financialCategoryId}`, { updatedData: req.body });
    res.json(updatedCategory);
  };
  ...
  const deleteRestaurantFinancialCategory = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_FINANCIAL_CATEGORY_DELETED', `Category:${financialCategoryId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantIngredient = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_INGREDIENT_CREATED', `Ingredient:${newIngredient.id}`, { name: newIngredient.name });
  ...
  const updateRestaurantIngredient = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_INGREDIENT_UPDATED', `Ingredient:${ingredientId}`, { updatedData: req.body });
  ...
  const deleteRestaurantIngredient = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_INGREDIENT_DELETED', `Ingredient:${ingredientId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantProduct = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_PRODUCT_CREATED', `Product:${newProduct.id}`, { name: newProduct.name });
  ...
  const updateRestaurantProduct = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_PRODUCT_UPDATED', `Product:${productId}`, { updatedData: req.body });
  ...
  const deleteRestaurantProduct = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_PRODUCT_DELETED', `Product:${productId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantSupplier = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_SUPPLIER_CREATED', `Supplier:${newSupplier.id}`, { name: newSupplier.name });
  ...
  const updateRestaurantSupplier = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_SUPPLIER_UPDATED', `Supplier:${supplierId}`, { updatedData: req.body });
  ...
  const deleteRestaurantSupplier = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_SUPPLIER_DELETED', `Supplier:${supplierId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantTable = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_TABLE_CREATED', `Table:${newTable.id}`, { tableNumber: newTable.table_number });
  ...
  const updateRestaurantTable = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_TABLE_UPDATED', `Table:${tableId}`, { updatedData: req.body });
  ...
  const deleteRestaurantTable = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_TABLE_DELETED', `Table:${tableId}`, {});
    res.status(204).send();
  };
  ...
  const createRestaurantTechnicalSpecification = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_TECHNICAL_SPEC_CREATED', `Spec:${newSpec.id}`, { name: newSpec.name });
  ...
  const updateRestaurantTechnicalSpecification = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_TECHNICAL_SPEC_UPDATED', `Spec:${technicalSpecificationId}`, { updatedData: req.body });
  ...
  const deleteRestaurantTechnicalSpecification = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'RESTAURANT_TECHNICAL_SPEC_DELETED', `Spec:${technicalSpecificationId}`, {});
    res.status(204).send();
  };
  ...
  const createWaiterOrder = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'WAITER_ORDER_CREATED', `Order:${newOrder.id}`, { tableId: req.body.table_id, totalItems: req.body.items.length });
  ...
  const updateWaiterOrder = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'WAITER_ORDER_UPDATED', `Order:${orderId}`, { updatedData: req.body });
  ...
  const createWaiterCall = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'WAITER_CALL_CREATED', `Call:${newCall.id}`, { tableId: req.body.table_id, callType: req.body.call_type });
  ...
  const updateWaiterCall = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'WAITER_CALL_UPDATED', `Call:${callId}`, { updatedData: req.body });
  ...
  const deleteWaiterCall = async (req, res, next) => {
    ...
    await auditService.log(req.user, restaurantId, 'WAITER_CALL_DELETED', `Call:${callId}`, {});
    res.status(204).send();
  };
