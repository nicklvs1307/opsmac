module.exports = (db) => {
    ...
    return {
        ...
        expireCoupons: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'COUPONS_EXPIRED', `Count:${updatedCount}`, {});
        ...
        redeemCoupon: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'COUPON_REDEEMED', `Coupon:${coupon.id}`, { code: coupon.code });
            res.json(coupon);
        },
        ...
        createCoupon: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'COUPON_CREATED', `Coupon:${coupon.id}`, { code: coupon.code, rewardId, customerId });
        ...
        validateCoupon: async (req, res, next) => {
            ...
            await auditService.log(req.user, restaurantId, 'COUPON_VALIDATED', `CouponCode:${code}`, { validationResult });
        ...
        publicValidateCoupon: async (req, res, next) => {
            ...
            await auditService.log(null, validationResult.restaurantId, 'PUBLIC_COUPON_VALIDATED', `CouponCode:${code}`, { validationResult });
            res.json(validationResult);
        },
    };
};
