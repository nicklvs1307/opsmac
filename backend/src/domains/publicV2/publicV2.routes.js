...
module.exports = (db) => {
    ...
    router.post('/feedback', (req, res, next) => asyncHandler(publicV2Controller.submitFeedback)(req, res, next));
    router.post('/checkin', (req, res, next) => asyncHandler(publicV2Controller.registerCheckin)(req, res, next));
