  ...
  return (
    <Dialog open={isOpen} onClose={onClose}>
      ...
      <DialogContent>
        ...
        <Controller name="city" control={control} render={({ field, fieldState: { error } }) => (
          <TextField
            {...field}
        ...
        <Controller name="state" control={control} render={({ field, fieldState: { error } }) => (
          <TextField
            {...field}
        ...
        <Controller name="owner_id" control={control} render={({ field, fieldState: { error } }) => (
