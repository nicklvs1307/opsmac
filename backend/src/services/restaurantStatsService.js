  ...
  const feedbackStats = await models.Feedback.findOne({
    ...
    attributes: [
      ...
      [
        models.Sequelize.fn(
          "COUNT",
          models.Sequelize.literal("CASE WHEN nps_score >= 9 THEN 1 END"),
        ),
        "promoters",
      ],
      [
        models.Sequelize.fn(
          ...
          models.Sequelize.literal(
            "CASE WHEN nps_score BETWEEN 7 AND 8 THEN 1 END",
          ),
        ),
        "passives",
      ],
      [
        models.Sequelize.fn(
          "COUNT",
          models.Sequelize.literal("CASE WHEN nps_score <= 6 THEN 1 END"),
        ),
        "detractors",
      ],
    ],
