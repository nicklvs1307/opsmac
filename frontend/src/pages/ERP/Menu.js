...
const ProductModal = ({ closeModal, onSave, product, categories }) => {
    ...
    useEffect(() => {
        if (product) setFormData({ name: product.name, description: product.description, price: product.price, category_id: product.category_id, is_active: product.is_active });
    }, [product]);
...
const VariationsTab = () => <div>Gerenciamento de Variações em breve...</div>;
