module.exports = (db) => {
  ...
  return {
    checkCheckinModuleEnabled: async (req, res, next) => {
      ...
      const restaurant = await checkinService.checkCheckinModuleEnabled(
        restaurantId,
        restaurantSlug,
      );
    ...
    getCheckinAnalytics: async (req, res, next) => {
      ...
      const analytics = await checkinService.getCheckinAnalytics(
        restaurantId,
        period,
      );
      res.json(analytics);
    ...
    getActiveCheckins: async (req, res, next) => {
      ...
      const activeCheckins =
        await checkinService.getActiveCheckins(restaurantId);
