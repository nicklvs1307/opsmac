...
import { usePaymentMethods, useCreatePaymentMethod, useUpdatePaymentMethod, useDeletePaymentMethod, } from '@/features/ERP/PaymentMethods/api/paymentMethodsQueries';
...
const PaymentMethods = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = usePaymentMethods(restaurantId, {
    onError: (error) => {
      toast.error(
