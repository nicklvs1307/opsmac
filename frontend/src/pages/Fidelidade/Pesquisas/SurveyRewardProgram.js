...
const SurveyRewardProgram = ({ control, errors, fields, append, remove, rewards, loading, onSave }) => {
        ...
        <Grid item xs={12}>
          <Card>
            ...
            <CardContent>
              ...
              <Box sx={{ mb: 4 }}>
                <Typography variant="h6" gutterBottom>{t('survey_reward_program.rewards_per_response')}</Typography>
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <FormControl fullWidth error={!!errors.rewards_per_response?.[index]?.reward_id}>
                              ...
                              <FormHelperText>{errors.rewards_per_response?.[index]?.reward_id?.message}</FormHelperText>
                            </FormControl>
                          )}
                        />
                      </Grid>
