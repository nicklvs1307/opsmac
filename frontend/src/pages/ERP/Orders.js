...
const Orders = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      {orders.length === 0 ? (
        <Typography variant="h6" align="center" sx={{ mt: 5 }}>Nenhum pedido encontrado.</Typography>
      ) : (
            ...
            <Grid item xs={12} md={6} lg={4} key={order.id}>
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography variant="body1" sx={{ mt: 1, fontWeight: 'bold', color: getStatusColor(order.status) }}>
                  ...
                  <Divider sx={{ my: 2 }} />
                  <Typography variant="h6" align="right">Total: R$ {Number(order.total_amount).toFixed(2)}</Typography>
